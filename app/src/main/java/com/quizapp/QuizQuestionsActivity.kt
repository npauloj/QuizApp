...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    //Function is auto created by Android when the Activity Class is created.
    ...
    // Gunction for setting the question to UI components.
    ...
    // Function to set default options view when the new question is loaded or when the answer is reselected.
    ...
    //Function for answer view which is used to highlight the answer is wrong or right.
